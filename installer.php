...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20230818_dienmayxanhmauwebdienmay_9123f00451d228c27048_20230818032219_archive.daf';
    const ARCHIVE_SIZE       = '97779140';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '9123f00-18032219';
    const VERSION            = '3.8.7';
    ...
    private function setPermsOnItem($path, $perms)
    {
        ...
        $perms_display = is_int($perms) ? decoct($perms) : $perms;
        if ($result === false) {
